...
const METHOD_INSPEKTOR_SEND_METRICS: ::grpcio::Method<
    super::api::MetricsRequest,
    super::api::Empty,
> = ::grpcio::Method {
    ty: ::grpcio::MethodType::Unary,
...
const METHOD_INSPEKTOR_GET_INTEGRATION_CONFIG: ::grpcio::Method<
    super::api::Empty,
    super::api::IntegrationConfigResponse,
> = ::grpcio::Method {
    ty: ::grpcio::MethodType::Unary,
...
impl InspektorClient {
    ...
    pub fn send_metrics_opt(
        &self,
        req: &super::api::MetricsRequest,
        opt: ::grpcio::CallOption,
    ) -> ::grpcio::Result<super::api::Empty> {
        self.client
            .unary_call(&METHOD_INSPEKTOR_SEND_METRICS, req, opt)
    }
    ...
    pub fn send_metrics_async_opt(
        &self,
        req: &super::api::MetricsRequest,
        opt: ::grpcio::CallOption,
    ) -> ::grpcio::Result<::grpcio::ClientUnaryReceiver<super::api::Empty>> {
        self.client
            .unary_call_async(&METHOD_INSPEKTOR_SEND_METRICS, req, opt)
    }
    ...
    pub fn get_integration_config_opt(
        &self,
        req: &super::api::Empty,
        opt: ::grpcio::CallOption,
    ) -> ::grpcio::Result<super::api::IntegrationConfigResponse> {
        self.client
            .unary_call(&METHOD_INSPEKTOR_GET_INTEGRATION_CONFIG, req, opt)
    }
    ...
    pub fn get_integration_config_async_opt(
        &self,
        req: &super::api::Empty,
        opt: ::grpcio::CallOption,
    ) -> ::grpcio::Result<::grpcio::ClientUnaryReceiver<super::api::IntegrationConfigResponse>>
    {
        self.client
            .unary_call_async(&METHOD_INSPEKTOR_GET_INTEGRATION_CONFIG, req, opt)
    }

    pub fn get_integration_config_async(
        &self,
        req: &super::api::Empty,
    ) -> ::grpcio::Result<::grpcio::ClientUnaryReceiver<super::api::IntegrationConfigResponse>>
    {
...
pub trait Inspektor {
    ...
    fn send_metrics(
        ...
        ctx: ::grpcio::RpcContext,
        req: super::api::MetricsRequest,
        sink: ::grpcio::UnarySink<super::api::Empty>,
    );
    fn get_integration_config(
        &mut self,
        ctx: ::grpcio::RpcContext,
        req: super::api::Empty,
        sink: ::grpcio::UnarySink<super::api::IntegrationConfigResponse>,
    );
}
...
pub fn create_inspektor<S: Inspektor + Send + Clone + 'static>(s: S) -> ::grpcio::Service {
    ...
    builder = builder.add_unary_handler(
        &METHOD_INSPEKTOR_GET_INTEGRATION_CONFIG,
        move |ctx, req, resp| instance.get_integration_config(ctx, req, resp),
    );
    builder.build()
}
